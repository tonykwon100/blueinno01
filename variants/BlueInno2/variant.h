...
#define BlueInnoPinMap(ulPin)	{								\	
	if(ulPin==UART_DEFAULT_TX_PIN) ulPin = ulPin - 10;			\
	else if(ulPin==UART_DEFAULT_RX_PIN) ulPin = ulPin - 10;		\
	else if(ulPin > 7) ulPin = ulPin + 4;						\
}
 ...
 * Wire Interfaces
 */
#define PIN_WIRE_SDA         5//(3u) // (6u)
#define PIN_WIRE_SCL         6//(4u) // (5u)
