...
void init(void)
{
	...
	UART0_Start( 9600, UART_DEFAULT_RX_PIN, UART_DEFAULT_TX_PIN );
	UART0_Stop();
	
	for(i=16;i<20;i++) 
	{
		//NRF_GPIO->PIN_CNF[i] = 1<<1;
	}
	
	//NRF_GPIO->PIN_CNF[16] = 1<<1;
	NRF_GPIO->PIN_CNF[17] = 1<<1;
	//NRF_GPIO->PIN_CNF[17] = 0;
	//NRF_GPIO->PIN_CNF[18] = 1<<1;
	//NRF_GPIO->PIN_CNF[19] = 1<<1;
